...
import {
  ...
  NimbleCardContent,
  NimbleCardHeader,
} from "@/components/ui/nimble-card";
          ...
          <NimbleCard className="max-w-md">
            ...
            <NimbleCardContent>
              <div className="text-sm">
                A fearsome undead creature that haunts the ancient crypts.
              </div>
            </NimbleCardContent>
          </NimbleCard>
        </section>
        ...
        <section>
          ...
          <NimbleCard className="nimbrew-font" style={{ width: "400px" }}>
            <NimbleCardHeader>
              ...
              <span
                className="text-xs opacity-50 inline-block ml-2"
                style={{
            ...
            <NimbleCardBanner>
              <div>
                ...
                <span className="ml-1">
                  Half damage from Necrotic and Piercing, double from Radiant.
                </span>
              </div>
              <div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <NimbleCard variant="simple">
              ...
              <p className="text-sm">
                A simplified version without the complex corner borders. Uses standard border-radius
                for a cleaner, modern look.
              </p>
            </NimbleCard>
            ...
            <NimbleCard variant="simple" className="nimble-card-accent">
              ...
              <p className="text-sm">
                Simple variant with accent color. Combines simplicity with visual emphasis.
              </p>
            </NimbleCard>
          </div>
        </section>
