    ...
    traits: [
      {
        ...
        ability: {
          ...
          name: "Advance!",
          description:
            "After you move toward an enemy, gain advantage on the first melee attack you make against it. When you use your Coordinated Strike, you and all allies within 12 spaces can first move up to half their speed for free.",
          type: "action",
          frequency: "per_turn",
...
export const commanderVanguard: SubclassDefinition = {
  ...
  description:
    "Commanders who become Champions of the Vanguard lead from the front, inspiring allies with aggressive tactics and coordinated assaults. They excel at creating opportunities for their team through superior positioning and timing.",
