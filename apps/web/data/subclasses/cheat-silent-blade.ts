...
const silentBladeFeatures: ClassFeature[] = [
  ...
  // Level 7
  {
    ...
    name: "Cunning Strike",
    description:
      "(2/encounter) When you land a Sneak Attack, you may force the target to make a STR save (DC 10+INT). On a failure, instead of rolling your Sneak Attack dice, you may do the maximum amount of damage (if your target saves, regain 1 use).",
    traits: [
      {
        ...
        ability: {
          ...
          name: "Cunning Strike",
          description:
            "When you land a Sneak Attack, you may force the target to make a STR save (DC 10+INT). On a failure, instead of rolling your Sneak Attack dice, you may do the maximum amount of damage (if your target saves, regain 1 use).",
          type: "action",
...
export const cheatSilentBlade: SubclassDefinition = {
  ...
  description:
    "Cheats who follow the path of the Silent Blade become masters of assassination and stealth. They strike from the shadows with lethal precision, leaving no trace of their presence.",
  parentClassId: "cheat",
