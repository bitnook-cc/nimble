...
export const oathswornVengeance: SubclassDefinition = {
  ...
  description:
    "An oath sworn to bring divine justice and retribution to those who have done wrong.",
  features: [
    {
      id: "aura-of-zeal",
      level: 3,
    ...
    },
    {
      ...
      description:
        "Increase your primary die rolls on melee attacks by 1 whenever you have Judgment Dice.",
      traits: [], // Passive feature - no mechanical traits to process
    },
    {
      id: "maximum-judgment",
